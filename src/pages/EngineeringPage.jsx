...
const EngineeringPage = () => {
  ...
  return (
    <div className="engineering-page" style={{ background: '#040711', minHeight: '100vh', paddingTop: '80px' }}>
      
      {/* Hero Header */}
      <section style={{
        position: 'relative',
        background: `linear-gradient(180deg, rgba(4, 7, 17, 0.85) 0%, rgba(4, 7, 17, 0.98) 100%), url(${engineeringBg})`,
        ...
        <div className="container" style={{ maxWidth: '960px', margin: '0 auto', textAlign: 'center' }}>
          ...
          <div style={{
            ...
            <Sparkles size={14} /> PROCESS-DRIVEN FILTRATION DESIGN
          </div>
            ...
            {engineeringSteps.map((step, idx) => (
              ...
              >
                ...
                <div>
                  ...
                  <p style={{ fontSize: '1.05rem', color: '#38bdf8', fontWeight: '600', marginBottom: '16px' }}>
                    {step.lead}
                  </p>
                  ...
                  <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '10px' }}>
                    {step.details.map((d, dIdx) => (
                      <li key={dIdx} style={{ display: 'flex', alignItems: 'flex-start', gap: '10px', fontSize: '0.92rem', color: '#cbd5e1', lineHeight: '1.6' }}>
                        <CheckCircle2 size={16} style={{ color: '#34d399', flexShrink: 0, marginTop: '4px' }} />
                        <span>{d}</span>
                      </li>
                    ))}
                  </ul>
      ...
      <section style={{ padding: '5rem 0', background: '#040711', borderTop: '1px solid rgba(255, 255, 255, 0.06)' }}>
        <div className="container" style={{ maxWidth: '960px', margin: '0 auto' }}>
          ...
          <div style={{
            ...
            <p style={{ fontSize: '1.02rem', lineHeight: '1.75', color: '#94a3b8', marginBottom: '20px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '18px', marginBottom: '28px' }}>
              <div style={{ background: 'rgba(2, 6, 23, 0.6)', padding: '16px', borderRadius: '12px', border: '1px solid rgba(255, 255, 255, 0.06)' }}>
                <div style={{ color: '#38bdf8', fontWeight: '700', fontSize: '0.92rem', marginBottom: '4px' }}>Air-to-Cloth Ratio</div>
                <div style={{ color: '#cbd5e1', fontSize: '0.85rem', lineHeight: '1.5' }}>Conservative filtration velocity prevents fine dust from embedding permanently into fabric pores.</div>
              </div>

              <div style={{ background: 'rgba(2, 6, 23, 0.6)', padding: '16px', borderRadius: '12px', border: '1px solid rgba(255, 255, 255, 0.06)' }}>
                <div style={{ color: '#38bdf8', fontWeight: '700', fontSize: '0.92rem', marginBottom: '4px' }}>Can Velocity Distribution</div>
                <div style={{ color: '#cbd5e1', fontSize: '0.85rem', lineHeight: '1.5' }}>Controlled upward gas speed inside the housing ensures pulsed dust drops straight into hoppers.</div>
              </div>

              <div style={{ background: 'rgba(2, 6, 23, 0.6)', padding: '16px', borderRadius: '12px', border: '1px solid rgba(255, 255, 255, 0.06)' }}>
                <div style={{ color: '#38bdf8', fontWeight: '700', fontSize: '0.92rem', marginBottom: '4px' }}>Dew Point Margin</div>
                <div style={{ color: '#cbd5e1', fontSize: '0.85rem', lineHeight: '1.5' }}>Thermal insulation and hopper heating prevent acid condensation and caked bag blindness.</div>
              </div>
            </div>
